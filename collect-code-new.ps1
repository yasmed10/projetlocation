# D̩finir le r̩pertoire courant
...
if ($fileCount -eq 0) {
    Write-Host "Aucun fichier trouv̩."
    exit
}

Write-Host "Nombre de fichiers trouv̩s: $fileCount"
...
Write-Host "Contenu copi̩ dans le presse-papiers!"
